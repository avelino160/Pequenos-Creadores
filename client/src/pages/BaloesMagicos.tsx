...
import { baloesProjetos, type BaloesProjeto } from '@/data/baloes-projetos';
import { useAuth } from '@/contexts/AuthContext';

export default function BaloesMagicos() {
  const [selectedProject, setSelectedProject] = useState<BaloesProjeto | null>(null);
  const { addViewedActivity } = useAuth();

  useEffect(() => {
    addViewedActivity('baloes-magicos');
  }, [addViewedActivity]);
              ...
              <TabsContent value="materials" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Separe tudo antes de começar com balões
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="tips" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Aproveite ao máximo sua experiência com balões
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              10 projetos divertidos com balões dobráveis para festas e brincadeiras!
            </p>
          </div>

          <div className="grid gap-3 md:grid-cols-2">
            {baloesProjetos.map((project) => (
              <Card
                key={project.id}
