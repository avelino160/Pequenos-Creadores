...
import { modelagemProjetos, type ModelagemProjeto } from '@/data/modelagem-projetos';
import { useAuth } from '@/contexts/AuthContext';

export default function ModelagemMassinha() {
  const [selectedProject, setSelectedProject] = useState<ModelagemProjeto | null>(null);
  const { addViewedActivity } = useAuth();

  useEffect(() => {
    addViewedActivity('modelagem-massinha');
  }, [addViewedActivity]);
              ...
              <TabsContent value="materials" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Separe tudo antes de começar a modelagem
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="tips" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Aproveite ao máximo sua experiência com massinha
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="objectives" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      O que seu filho aprenderá com este projeto
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              10 projetos incríveis de modelagem, do fácil ao avançado!
            </p>
          </div>

          <div className="grid gap-3 md:grid-cols-2">
            {modelagemProjetos.map((project) => (
              <Card
                key={project.id}
